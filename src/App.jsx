      ...
      <main className="pt-16">
        ...
        <section className="py-16 px-8">
          ...
          <p className="mt-4 text-center max-w-2xl mx-auto">
            Passionate about web development with expertise in HTML, CSS, JavaScript, React, and Node.js, Java.
          </p>
        </section>
        ...
        <section className="py-16 px-8">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-6">
            ...
            <span className="px-4 py-2 bg-cyan-600 text-white rounded-full">Java</span>
            <span className="px-4 py-2 bg-indigo-600 text-white rounded-full">C#</span>
          </div>
        </section>
